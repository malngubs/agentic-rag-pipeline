 ...
 * ============================================================================
 *
 * Shows a preview of uploaded documents in chat.
 * Similar to how ChatGPT displays document content after upload.
 *
 * Features:
 * - Shows file metadata (name, type, size)
 * - Shows data statistics for tabular files
 * - Expandable preview of content
 * - Column information for Excel/CSV files
 */
